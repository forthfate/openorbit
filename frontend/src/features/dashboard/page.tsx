...
function OperationalHealth({locale}:{locale:Locale}){
  ...
  const copy=operations[locale],summary=analytics?.operational_summary
  const trend=useMemo(()=>{
